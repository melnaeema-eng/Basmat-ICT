  ...
  async function saveCustomer(event) {
    ...
    try {
      ...
      if (vatNumber && !/^\d{15}$/.test(vatNumber)) {
        throw new Error("الرقم الضريبي يجب أن يتكون من 15 رقمًا.");
      }
        ...
        >
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            ...
            <Input
              ...
              onChange={(v) => setField("vat_number", v.replace(/\D/g, "").slice(0, 15))}
            />
            ...
            <Input
              ...
              dir="ltr"
              onChange={(v) => setField("cr_number", v)}
            />

            <Input
              label="العنوان / عنوان الفوترة"
          ...
          {filtered.map((customer) => (
            ...
            >
              ...
              <div className="mt-5 space-y-2 text-sm text-slate-600">
                ...
                <p>{customer.city || "—"}</p>
                {customer.vat_number && (
                  <p dir="ltr">VAT: {customer.vat_number}</p>
                )}
                {customer.cr_number && (
                  <p dir="ltr">CR: {customer.cr_number}</p>
                )}
